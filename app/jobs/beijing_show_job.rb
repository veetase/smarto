class BeijingShowJob
  ...
  def zone_init_maps
    {beijing_a: set_position(80...160, 160...320), beijing_b: set_position(100...230, 40...155), beijing_c: set_position(320...380, 100...150), beijing_d: set_position(250...350, 250...300)}
  end
